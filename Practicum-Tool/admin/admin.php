    ...
    <main>
        <div class="column main">
            ...
            <div class="box-link-container">
                <a href="account.php" class="box-link">
                    <span>Create Admin Account</span>
                    <img src="../images/links/account.png" class="link-img" alt="Create Account Icon" width="100px" height="100px">
                </a>
                ...
                <a href="list.php" class="box-link" id="admin_list">
                    <span>View List</span>
