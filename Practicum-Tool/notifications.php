...
$total_notif = Notification::CountNotifications($conn, $studentId);
$total_pages = ceil($total_notif / $limit);
$notifications = Notification::GetAllNotifications($conn, $studentId, $limit, $offset);
?>
...
<body>
    ...
    <main>
        ...
        <div class="box-blue w-800">
            <?php Notification::DisplayAllStudentNotifications($conn, $notifications); ?>
